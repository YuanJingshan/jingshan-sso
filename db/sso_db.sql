...
-- ----------------------------
INSERT INTO `oauth_client_details` VALUES ('app_audit', null, '$2a$10$ZRmPFVgE6o2aoaK6hv49pOt5BZIKBDLywCaFkuAs6zYmRkpKHgyuO', 'all', 'authorization_code,refresh_token', 'http://localhost:8082/audit/login', null, '7200', null, null, 'true');
INSERT INTO `oauth_client_details` VALUES ('app_auth', null, '$2a$10$ZRmPFVgE6o2aoaK6hv49pOt5BZIKBDLywCaFkuAs6zYmRkpKHgyuO', 'all', 'authorization_code,refresh_token', 'http://localhost:8081/auth/login', null, '7200', null, null, 'true');
INSERT INTO `oauth_client_details` VALUES ('app_yyc', null, '$2a$10$8yVwRGY6zB8wv5o0kRgD0ep/HVcvtSZUZsYu/586Egxc1hv3cI9Q6', 'all', 'authorization_code,refresh_token', 'http://localhost:8083/yyc/login', null, '7200', null, null, 'true');
...
INSERT INTO `sys_permission` VALUES ('2', '0', '3', 'detail', 'member:detail', '/detail', '1', 'system', '2019-03-03 18:50:17', 'system', '2019-03-03 18:50:20');
